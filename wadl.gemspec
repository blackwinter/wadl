...
Gem::Specification.new do |s|
  ...
  s.files = ["lib/wadl.rb", "lib/wadl/version.rb", "README", "ChangeLog", "Rakefile", "COPYING", "examples/yahoo.wadl", "examples/YahooSearch.rb", "examples/crummy.rb", "examples/yahoo.rb", "examples/crummy.wadl", "examples/delicious.wadl", "examples/YahooSearch.wadl", "examples/delicious.rb", "test/test_wadl.rb"]
